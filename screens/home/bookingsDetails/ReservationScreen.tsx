...
import NoCarReservationDetails from './NoCarReservationScreen';
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: 'white', }}>
      <ScrollView contentContainerStyle={{ backgroundColor: 'white', flexGrow: 1 }}>
        {(!route.params.booking.vehicleType || route.params.booking.vehicleType == MarkerVehicleType.SHARE) && (
        ...
        {(route.params.booking && route.params.booking != MarkerVehicleType.SHARE )  && (
          <NoCarReservationDetails params={route.params} />
        )}
      </ScrollView>
    </SafeAreaView>
  );
            ...
            return (
              <View style={{ width: '25%' }}>
                <TouchableOpacity disabled={cannotCollect} style={{ height: '100%' }} onPress={() => {
                  ...
                  if (!route?.params?.params?.booking.vehicleType || route?.params?.params?.booking?.vehicleType == MarkerVehicleType.SHARE) {
                    setIsAllowing(true)
                  } else {
